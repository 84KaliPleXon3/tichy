...
PyMODINIT_FUNC initversion(void) {
  ...
  /*--- Intern code ---*/
  __pyx_int_3 = PyInt_FromLong(3); if (unlikely(!__pyx_int_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1;};
 ...
 * __version__ = 3             # <<<<<<<<<<<<<< 
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_n___version__, __pyx_int_3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L1;}
  return;
  __pyx_L1:;
