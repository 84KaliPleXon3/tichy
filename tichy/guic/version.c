/* Generated by Cython 0.9.6.14 on Mon Nov 17 17:45:23 2008 */
...
PyMODINIT_FUNC initversion(void) {
  ...
  /* "/home/charlie/Work/tichy/tichy/guic/version.pyx":25
 * """
 * 
 * __version__ = 1             # <<<<<<<<<<<<<< 
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_n___version__, __pyx_int_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1;}
  return;
  __pyx_L1:;
