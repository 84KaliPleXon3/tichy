...
class DrawingWidget(gui.SurfWidget):
    ...
    def update_shape(self):
        radius = self.radius
        self.shape = pygame.Surface((radius * 2, radius * 2), pygame.SRCALPHA, 32).convert_alpha()
    ...
    def mouse_motion(self, pos):
        ...
        for i in range(nb_points):
            ...
            redraw_rect = redraw_rect.merge(Rect((ipos.x, ipos.y), (self.radius * 2, self.radius * 2))) # TODO: allow better rect constructors
...
class DrawingApp(tichy.Application):
    ...
    def run(self, parent):
        ...
        for c, name in [((255,0,0), 'red'), ((0,255,0), 'green'), ((0,0,255), 'blue'), ((255,255,255),'white')]:
